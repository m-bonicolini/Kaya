...
#define TERM_RX_STATUS(devnum) 			((termreg_t *) (TERM_DEVREG_BASE+devnum*sizeof(devreg_t)))->recv_status 
#define TERM_RX_CMD(devnum) 			((termreg_t *) (TERM_DEVREG_BASE+devnum*sizeof(devreg_t)))->recv_command 
#define TERM_TX_STATUS(devnum) 			((termreg_t *) (TERM_DEVREG_BASE+devnum*sizeof(devreg_t)))->transm_status 
#define TERM_TX_CMD(devnum) 			((termreg_t *) (TERM_DEVREG_BASE+devnum*sizeof(devreg_t)))->transm_command 




#define INTERVALTIMER 0x1000.0020; // aggiunto da noi
